...
export const neutralColors: EnumColors = {
  ...
  menuHighlight: "focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground",
};
...
export const severityGoodColors: EnumColors = {
  ...
  menuHighlight: "focus:bg-severity-good/15 focus:text-severity-good-foreground focus:**:text-severity-good-foreground",
};
...
export const severityWarningColors: EnumColors = {
  ...
  menuHighlight:
    "focus:bg-severity-warning/15 focus:text-severity-warning-foreground focus:**:text-severity-warning-foreground",
};
...
export const severitySeriousColors: EnumColors = {
  ...
  menuHighlight:
    "focus:bg-severity-serious/15 focus:text-severity-serious-foreground focus:**:text-severity-serious-foreground",
};
...
export const severityCriticalColors: EnumColors = {
  ...
  menuHighlight:
    "focus:bg-severity-critical/15 focus:text-severity-critical-foreground focus:**:text-severity-critical-foreground",
};
...
export const roleOwnerColors: EnumColors = {
  ...
  menuHighlight: "focus:bg-role-owner/15 focus:text-role-owner-foreground focus:**:text-role-owner-foreground",
};
...
export const roleAdminColors: EnumColors = {
  ...
  menuHighlight: "focus:bg-role-admin/15 focus:text-role-admin-foreground focus:**:text-role-admin-foreground",
};
...
export const roleMemberColors: EnumColors = {
  ...
  menuHighlight: "focus:bg-role-member/15 focus:text-role-member-foreground focus:**:text-role-member-foreground",
};
